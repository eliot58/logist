    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('call_status', models.CharField(default='no call', max_length=60, verbose_name='Статус звонка')),
                ('call_audio', models.FileField(blank=True, null=True, upload_to='audio', verbose_name='Результат созвона в аудио')),
